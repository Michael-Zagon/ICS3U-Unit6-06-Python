...
def conversion(user_input):
    ...
    for single_character in user_input:
        if single_character in unicode_string:
            hexidecimal += unicode_string[single_character]
        else:
            return "-1"

    print("")
    return user_input + " in hex is [" + hexidecimal + "]"


def main():
    # This function takes input and prints output

    user_input = input("Please enter a string to convert to hex: ")
